...
public class FormController {
    ...
    public static void uploadCourses(FrmGetAttendanceRecord frame) {
        DataPersistence dataPersistence;
        dataPersistence = DataPersistence.getInstance();
        String[] coursesArray;
        coursesArray = new String[dataPersistence.getTeacher().getCourses().size()];
    ...
    public static void uploadCourses(FrmTakeAttendance frame) {
        DataPersistence dataPersistence;
        dataPersistence = DataPersistence.getInstance();
        String[] coursesArray;
        coursesArray = new String[dataPersistence.getTeacher().getCourses().size()];
    ...
    public static void uploadCourses(FrmGetGradeRecord frame) {
        DataPersistence dataPersistence;
        dataPersistence = DataPersistence.getInstance();
        String[] coursesArray;
        coursesArray = new String[dataPersistence.getTeacher().getCourses().size()];
    ...
    public static void uploadCourses(FrmAddGrade frame) {
        DataPersistence dataPersistence;
        dataPersistence = DataPersistence.getInstance();
        String[] coursesArray;
        coursesArray = new String[dataPersistence.getTeacher().getCourses().size()];
    ...
    public static void uploadCourses(FrmRemoveStudent frame) {
        DataPersistence dataPersistence;
        dataPersistence = DataPersistence.getInstance();
        String[] coursesArray;
        coursesArray = new String[dataPersistence.getTeacher().getCourses().size()];
    ...
    public static void uploadCourses(FrmAddStudent frame) {
        DataPersistence dataPersistence;
        dataPersistence = DataPersistence.getInstance();
        String[] coursesArray;
        coursesArray = new String[dataPersistence.getTeacher().getCourses().size()];
    ...
    public static void uploadCourses(FrmShowEnrolledStudents frame) {
        DataPersistence dataPersistence;
        dataPersistence = DataPersistence.getInstance();
        String[] coursesArray;
        coursesArray = new String[dataPersistence.getTeacher().getCourses().size()];
    ...
    public static void showTableDate(FrmGetAttendanceRecord frame) {
        ...
        ArrayList<Student> students = dataPersistence.getTeacher().getCourses().get(dataPersistence.getPosition()).getStudents();
        
        // Crear una copia del ArrayList original
        ArrayList<Student> studentsCopy = new ArrayList<>(students);
        
        // Ordenar la copia del ArrayList por nombre usando Comparator
    ...
    public static ArrayList<Object> buildRow(Float studentAttendace, FrmGetAttendanceRecord frame) {
        ...
        studentRow.add(String.valueOf(num + 1));
        studentRow.add(studentsCopy.get(num).getEspeId());
        studentRow.add(studentsCopy.get(num).getName());
    ...
    public static void login(FrmLogin frame) throws HeadlessException {
        ...
        if (validated == 1) {
            JOptionPane.showMessageDialog(frame, "BIENVENIDO", "INICIAR SESION", INFORMATION_MESSAGE);
            emptyFields(frame);
            ...
            JOptionPane.showMessageDialog(frame, "ERROR", "INICIAR SESION", INFORMATION_MESSAGE);
            emptyFields(frame);
        }
    }
